...
class alignas(VL_CACHE_LINE_BYTES) VTop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ Top__DOT__writeback__DOT____VdfgTmp_hb47b8516__0;
    ...
    struct {
        ...
        VlWide<7>/*208:0*/ Top__DOT__decodeExecutePayload;
        VlWide<6>/*181:0*/ Top__DOT__executeMemoryPayload;
        VlWide<4>/*110:0*/ Top__DOT__memoryWritebackPayload;
        VlWide<7>/*208:0*/ Top__DOT__decode__DOT__decodeExecuteCandidate;
